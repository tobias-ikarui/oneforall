 ...
 */
export declare function cutIfTooLong(text: string, maxLength: number, endTextIfTooLong?: string): string;
/**
 ...
 */
export declare function getKeyByValue<O extends {
    [key: string]: any;
}>(object: O, value: O[keyof O]): keyof O | undefined;
/**
 ...
 */
export declare function isOwner(id: Snowflake): boolean;
/**
 ...
 */
export declare function isSnowflake(value: string): value is Snowflake;
/**
 ...
 */
export declare function isTextChannelLike(value: any): value is TextChannelLike;
/**
 ...
 */
export declare function random<T extends any>(array: T[]): T;
