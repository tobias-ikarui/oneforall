    ...
    class CustomGuild extends Guild {
        ...
        updateSoutien(soutienId, soutienMsg, soutienOn) {
            this.client.database.models.guildConfig.update({
                ...
                this.config.soutienMsg = soutienMsg;
                this.config.soutienOn = soutienOn;
                this.config.soutienId = soutienId;
            })
        }
        ...
        async updateCounter(memberCount,botCount, voiceCount, onlineCount, offlineCount, channelCount, roleCount, boosterCount) {
            await this.client.database.models.guildConfig.update({
                memberCount,
                voiceCount,
                onlineCount,
